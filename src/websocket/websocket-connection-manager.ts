...
import { blobToByteArray } from '@/utils/binary-utils.ts';
import { ClientDiscoveryConfig, fetchClientDiscovery } from '@/services/well-known.service.ts';
...
export class WebsocketConnectionManager {
  ...
  constructor(config: RpcConnectionConfig, eventEmitter: WebsocketEventEmitter) {
    this.config = config;
