...
import WebsocketConnectionManager from './websocket-connection-manager.ts';
import WebsocketEncryptionService from './websocket-encryption-service.ts';
import WebsocketEventEmitter from './websocket-event-emitter.ts';
import WebsocketMessageHandler from './websocket-message-handler.ts';
import WebsocketQueueManager from './websocket-queue-manager.ts';
import WebsocketAuthService from './websocket-auth-service.ts';
import { KeyPair } from '@/utils/cipher-utils.ts';
import IWebsocketService from '@/websocket/IWebsocketService.ts';
import ClientService from '@/websocket/services/client.service.ts';
...
class WebsocketLifecycleService implements IPacketService {
  ...
  constructor(url: string, authToken: string | null, baseReconnectInterval: number = 5000) {
    ...
    this.registerService(new RoomService(this, this.eventEmitter));
